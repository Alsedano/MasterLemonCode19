...
Crea una función set que reciba un objeto con los campos de usuario, el nombre de una propiedad y su valor y actualice la propiedad del objeto con el valor pasado como argumento.
...
function set(prop) {
    return function setValue(user, value) {
        const updatedUser = { ...user };
        updatedUser[prop] = value;
        return updatedUser;
    }
